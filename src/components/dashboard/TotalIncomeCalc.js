...
export default function TotalIncomeCalc({ title, rate, children }) {
  return (
    <div className="bg-bgBlur border border-zinc-800 rounded-xl md:rounded-3xl px-4 py-4 w-full   ">
      ...
      <div className="flex gap-2 items-center">
        ...
        <p className="bg-walletColor p-1 text-xs text-buttonOrange w-fit rounded-full ">
          +{rate}%
        </p>
      </div>
    </div>
